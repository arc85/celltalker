...
group1.exp <- unnest(putative.interactions.tib[putative.interactions.tib$name %in% group1,2]) %>% pull()
group2.exp <- unnest(putative.interactions.tib[putative.interactions.tib$name %in% group2,2]) %>% pull()
